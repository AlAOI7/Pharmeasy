...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['followup_date_done'])) {
    $id = $_POST['cus_id'];
    
    $followup_date_done = $admin->customerFolloupDone($id);
}

    $getCus = $admin->getAllCustomerFollowup();
?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    if (isset($followup_date_done)) {
                        echo $followup_date_done;
                    }
                    ?>
                    <div class="card-body">
                        <h5 class="card-title">All Pending Customer</h5>
                                    ...
                                    if ($getCus) {
                                        ...
                                        <form class="form-horizontal" method="post" action="">
                                            <td>
                                                ...
                                                <button type="submit" name="followup_date_done" class="btn btn-success btn-sm">Done</button>
                                            </td>
