...
if (isset($_POST['search'])) {
    ...
    $getSalesReport = $report->getAllSalesReturnReportDate($from, $to);
} else {
    $getSalesReport = $report->getAllSalesReturnReport();
}
?>
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Sales Return Report</h4>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">All Sales Return Report</h5>
