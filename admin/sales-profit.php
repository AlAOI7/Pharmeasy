                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">sales profit report</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">All Sales Profit Report</h5>
                            ...
                            <table id="buttonTab" class="table table-striped table-bordered display tblReport">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:20px;">Total Sale (Cash + Due)</th>
                                    ...
                                    if ($getSaleReport) {
                                        ...
                                        while ($result = $getSaleReport->fetch_assoc()) {
                                            ...
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td>
                                                    <a target="_blank" href="cusinv.php?invid=<?php echo $result['id']; ?>"><?php echo $result['invoice_number']; ?></a>
                                                </td>
                                                <td>
