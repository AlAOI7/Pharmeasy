...
if (isset($_GET['delid'])) {
    $id = $_GET['delid'];
    $genericDel = $medicine->deleteGeneric($id);
}
?>
                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">generic</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    ?>
                    <div class="card-body">
                        <h5 class="card-title">All Generic</h5>
                        <div class="box-tools pull-right" align="right">
                            <a href="add-generic.php"><button type="button" class="btn btn-success"><i class="fas fa-plus"></i>Add Generic</button></a>
                        </div><br>
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-striped table-bordered tbl">
                                ...
                                <tbody>
                                    <?php
                                    $getGeneric = $medicine->getAllGeneric();
                                    if ($getGeneric) {
                                        $i = 0;
                                        while ($result = $getGeneric->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit-generic.php?sid=<?php echo $result['id']; ?>"><button type="button" class="btn btn-cyan btn-sm">Edit</button></a>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
