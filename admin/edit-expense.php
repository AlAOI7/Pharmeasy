...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $expUpdate = $report->updateExpense($_POST, $sid);
}
?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    ?>
                    <?php
                    $getInfo = $report->getExpenseById($sid);
                    if ($getInfo) {
                                    ...
                                    <div class="row">	
                                        <div class="col-md-6">
                                                ...
                                                <select class="form-control" name="expenseHead" required>
                                                    ...
                                                    if ($getType) {
                                                        while ($result = $getType->fetch_assoc()) {
                                                            if ($res['expense_head'] == $result['id']) {
                                                                ?>
                                                                <option value="<?php echo $result['id']; ?>" selected="selected"><?php echo $result['expense_head_name']; ?></option>
                                                                <?php
                                                            } else {
                                                                ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="uname" name="expense_amount" value="<?php echo $res['expense_amount']; ?>" placeholder="Amount" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="datepicker-autoclose" autocomplete="off" name="expenseDate" value="<?php echo $res['expense_date']; ?>" placeholder="mm/dd/yyyy">
                                            </div>
                                            <div class="form-group">
