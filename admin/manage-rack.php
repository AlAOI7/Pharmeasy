        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    ?>
                    <div class="card-body">
                        <h5 class="card-title">All Rack</h5>
                        <div class="box-tools pull-right" align="right">
                            <a href="add-rack.php"><button type="button" class="btn btn-success"><i class="fas fa-plus"></i>Add Rack</button></a>
                        </div><br>
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-striped table-bordered tbl">
                                ...
                                <tbody>
                                    <?php
                                    $getRack = $admin->getAllRack();
                                    if ($getRack) {
                                        $i = 0;
                                        while ($result = $getRack->fetch_assoc()) {
                                            $i++;
                                            ?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                ...
                                                <td>
                                                    <a href="edit-rack.php?sid=<?php echo $result['id']; ?>"><button type="button" class="btn btn-cyan btn-sm">Edit</button></a>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
