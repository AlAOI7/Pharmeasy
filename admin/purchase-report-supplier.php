...
if (isset($_POST['search'])) {
    ...
    $getPurReport = $report->getAllPurchaseReportDateSupplier($from, $to, $sup);
} else {
    $getPurReport = $report->getAllPurchaseReport();
}
?>
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Purchase Report (Supplier wise)</h4>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">All Purchase Report (Supplier wise)</h5>
                                ...
                                <tbody>
                                    ...
                                    if ($getPurReport) {
                                        ...
                                        while ($result = $getPurReport->fetch_assoc()) {
                                            ...
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><a target="_blank" href="supinvpur.php?invid=<?php echo $result['invoice_number']; ?>"><?php echo $result['invoice_number']; ?></a></td>
                                                <td>
                                                    <?php
