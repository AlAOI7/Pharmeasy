...
if (isset($_GET['delid'])) {
    $delid = $_GET['delid'];
    $exDel = $report->deleteOverhead($delid);
}
?>
                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">over head</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    ?>
                    <div class="card-body">
                        <h5 class="card-title">All Overhead</h5>
                        <div class="box-tools pull-right" align="right">
                            <a href="add-overhead.php"><button type="button" class="btn btn-success"><i class="fas fa-plus"></i>Add Overhead</button></a>
                        </div><br>
                                ...
                                <tbody>
                                    ...
                                    if ($getHead) {
                                        ...
                                        while ($result = $getHead->fetch_assoc()) {
                                            ...
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><?php echo $result['overhead_name']; ?></td>
                                                <td>
