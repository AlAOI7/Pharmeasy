    ...
    <div class="container-fluid">
        ...
        <div class="row">
                                            ...
                                            while ($result = $GetPurInfo->fetch_assoc()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td class="text-right">
                                                        <?php
                                                        $medistk = $medicine->getOneCol('stock', 'medicine', 'id', $result['medicine']);
                                                        echo $medistk;
                                                        ?>
                                                    </td>
            ...
            <footer class="footer text-center">
                All Rights Reserved. Designed and Developed by <a href="http://softwaresolutioncompany.com/">Universal It</a>.
            </footer>
        </div>
