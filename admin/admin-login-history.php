...
if (isset($_POST['search'])) {
    ...
    $getHistory = $report->getAdminLoginHistoryDate($from, $to);
} else {
    $getHistory = $report->getAdminLoginHistory();
}
?>
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">User Login History</h4>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">All User Login History</h5>
