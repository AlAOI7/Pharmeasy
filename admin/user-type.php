...
if (isset($_GET['delid'])) {
    $delid = $_GET['delid'];
    $unitDel = $medicine->deleteUserType($delid);
}
?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    ?>
                    <div class="card-body">
                        <h5 class="card-title">All User Type</h5>
                        <div class="box-tools pull-right" align="right">
                            <a href="add-user-type.php"><button type="button" class="btn btn-success"><i class="fas fa-plus"></i>Add User Type</button></a>
                        </div><br>
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-striped table-bordered tbl">
                                ...
                                <tbody>
                                    <?php
                                    $getUtype = $medicine->getAllUserType();
                                    if ($getUtype) {
                                        $i = 0;
                                        while ($result = $getUtype->fetch_assoc()) {
                                            $i++;
                                            ?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
