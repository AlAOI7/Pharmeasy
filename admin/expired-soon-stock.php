    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Expired Soon Medicine/Product</h4>
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">expired soon stock</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    ?>
                    <div class="card-body">
                        <h5 class="card-title">All Expired Soon Medicine/Product</h5>
                                ...
                                <tbody>
                                    ...
                                    if ($getStk) {
                                        ...
                                        <form class="form-horizontal" method="post" action="">
                                            <td>
                                                <input type="number" class="form-control" name="rmStk" value="0" required="">
