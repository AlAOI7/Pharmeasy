...
--
-- Host: 127.0.0.1
-- Generation Time: 14 أبريل 2025 الساعة 10:21
...
--
-- بنية الجدول `admin_login_history`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `admin_login_history`
--

INSERT INTO `admin_login_history` (`id`, `username`, `name`, `browser`, `date`, `date_time`, `deletion_status`) VALUES
(0, 'admin', 'Admin', 'Chrome', '2025-04-14', '2025-04-13 23:44:33', 0);
...
--
-- إرجاع أو استيراد بيانات الجدول `bank`
--
...
--
-- بنية الجدول `collection_invoice_count`
--
...
--
-- بنية الجدول `customer_collection`
--
...
--
-- بنية الجدول `customer_invoice_info`
--
...
--
-- بنية الجدول `customer_return_invoice_info`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `customer_type`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `expense_head`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `income_head`
--
...
--
-- بنية الجدول `payment_invoice_count`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `product_type`
--
...
--
-- بنية الجدول `purchase_product_info`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `purchase_product_info`
--
...
--
-- بنية الجدول `purchase_return_product_info`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `rack`
--
...
CREATE TABLE `return_cart` (
  ...
  `user_id` int(11) NOT NULL,
  `user_name` varchar(255) NOT NULL,
  `common_id` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 1,
  `deletion_status` tinyint(4) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- بنية الجدول `return_sale_product_info`
--
...
--
-- بنية الجدول `salesman_login_history`
--
...
--
-- بنية الجدول `sale_invoice_count`
--
...
--
-- بنية الجدول `sale_return_invoice_count`
--
...
--
-- بنية الجدول `supplier_invoice_info`
--
...
--
-- بنية الجدول `supplier_return_invoice_info`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `tbl_user_type`
--
